...
data class MaestroCommand(
    ...
    val dragAndDropCommand: DragAndDropCommand? = null,
    ...
    constructor(command: Command) : this(
        ...
        dragAndDropCommand = command as? DragAndDropCommand,
    ...
    fun asCommand(): Command? = when {
        ...
        dragAndDropCommand != null -> dragAndDropCommand
    ...
    fun elementSelector(): ElementSelector? {
        return when {
            ...
            dragAndDropCommand?.from != null -> dragAndDropCommand.from
